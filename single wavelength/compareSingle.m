...
P.useSaturation = 0;        % detector saturation
P.makeESWAIm = 1;           % display generated surface waves
...
P.flux = 1e8;                   % number of photons incident on object
...
% Select monochromatization algorithm ("CGLS" or "BiCGSTAB"):
